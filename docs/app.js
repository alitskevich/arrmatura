...
/*!******************!*\
  !*** ./index.js ***!
  \******************/
/*! exports provided: launch, loadTemplates, commonPipes, commonTypes, Service */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony import */ var _component_utils__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./component.utils */ "./lib/component.utils.js");
...
function () {
  function Component(Ctor, options) {
    ...
    if (parent) {
      ...
      this.impl = new (Ctor || _element__WEBPACK_IMPORTED_MODULE_3__["Element"])(props, this);
      this.impl.$ = this;
  ...
  _createClass(Component, [{
    ...
    value: function done() {
      ...
      ['parent', 'children', 'owner', 'impl', 'app'].forEach(function (k) {
        delete _this3[k];
      });
    }
    /**
    ...
    value: function set(Δ) {
      ...
      if (impl.set) {
        ...
        if (Δ.then) {
          Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["upAsync"])($, Δ);
        } else {
          Object.entries(Δ).forEach(function (_ref) {
            ...
            if (their && their.then) {
              Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["upAsync"])($, their, k);
    ...
    value: function prop(propId) {
      var value = Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["propGetter"])(this, propId)();
      return value;
    }
    /**
     *  Left Arrow.
    ...
    value: function subscribe(target, fn) {
      ...
      var uuid = Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["nextId"])();
    ...
    value: function connect(key, applicator) {
      ...
      return ref.$.subscribe(this, function ($) {
        return Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["applyValue"])($.prop(propId), applicator);
      });
    }
    /**
     *  Right Arrow.
    ...
    value: function emit(key, data) {
      ...
      try {
        var method = ref[Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["methodName"])(target, 'on')];

        if (!method) {
          throw new ReferenceError('emit ' + type + ': No such method ' + Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["methodName"])(target, 'on'));
        }

        var result = method.call(ref, event, ref, ref.$);
        this.log(type + ':' + Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["methodName"])(target, 'on'), result, data, ref);
    ...
    value: function res(key) {
      return Object(_component_utils__WEBPACK_IMPORTED_MODULE_2__["res"])(this.app, key);
    }
  }, {
...
/*!********************************!*\
  !*** ./lib/component.utils.js ***!
  \********************************/
/*! exports provided: nextId, applyValue, methodName, upAsync, propGetter, res */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "upAsync", function() { return upAsync; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "propGetter", function() { return propGetter; });
...
function cleanupAttributes() {
  this.$attributes = null; // const lstnrs = this.listeners;
  // if (lstnrs) {
...
/*!****************************!*\
  !*** ./lib/dom.manager.js ***!
  \****************************/
/*! exports provided: DomAppManager */
/***/ (function(module, __webpack_exports__, __webpack_require__) {

"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "DomAppManager", function() { return DomAppManager; });
...
/*#__PURE__*/
function () {
  function DomAppManager(props) {
    _classCallCheck(this, DomAppManager);

    Object.assign(this, props);
    this.elt = this.rootElement || document.body;
  }

  _createClass(DomAppManager, [{
    key: "onCreateElement",
    value: function onCreateElement(E, tag, attrs) {
      E.elt = tag === '#text' ? document.createTextNode('') : document.createElement(tag);
      E.elt.impl = E;
      _dom_attrs__WEBPACK_IMPORTED_MODULE_0__["applyAttributes"].call(E, attrs);
      var $p = E.$.parent;
    ...
    key: "onDoneElement",
    value: function onDoneElement(E) {
      var e = E.elt;
      ...
      _dom_attrs__WEBPACK_IMPORTED_MODULE_0__["cleanupAttributes"].call(E);
      E.elt = null;
    }
  }, {
    key: "onRenderElement",
    value: function onRenderElement(E, attrs, content, render) {
      var e = E.elt; // render underlying content
      ...
      var p = E.parent.impl.elt; // Case 1. we are under parent rendering flow

      if (p.cursor) {
        var before = p.cursor.elt ? p.cursor.elt.nextSibling : p.firstChild;
        append(e, p, before);
...
function () {
  ...
  _createClass(Element, [{
    ...
    key: "render",
    value: function render() {
      this.$.app.onRenderElement(this, this.delta, this.$.content, _render_js__WEBPACK_IMPORTED_MODULE_0__["render"]);
      this.delta = null;
    }
  }]);
...
/*!*************************!*\
  !*** ./lib/fragment.js ***!
  \*************************/
/*! exports provided: Fragment, FragmentSlot, FragmentForItem, FragmentFor, FragmentIf, FragmentTag, allFragments */
/***/ (function(module, __webpack_exports__, __webpack_require__) {
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "allFragments", function() { return allFragments; });
...
var allFragments = [['ui:fragment', Fragment], ['ui:for', FragmentFor], // ['ui:item', FragmentForItem],
['ui:if', FragmentIf], ['ui:tag', FragmentTag], ['ui:slot', FragmentSlot]];
...
/* harmony import */ var _render__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(/*! ./render */ "./lib/render.js");
/* harmony import */ var _register_js__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(/*! ./register.js */ "./lib/register.js");
/* harmony import */ var _dom_manager__WEBPACK_IMPORTED_MODULE_3__ = __webpack_require__(/*! ./dom.manager */ "./lib/dom.manager.js");
function _typeof(obj) { if (typeof Symbol === "function" && typeof Symbol.iterator === "symbol") { _typeof = function _typeof(obj) { return typeof obj; }; } else { _typeof = function _typeof(obj) { return obj && typeof Symbol === "function" && obj.constructor === Symbol && obj !== Symbol.prototype ? "symbol" : typeof obj; }; } return _typeof(obj); }
...
function launch() {
  var _ref = arguments.length > 0 && arguments[0] !== undefined ? arguments[0] : {},
      ...
      props = _objectWithoutProperties(_ref, ["types", "template"]);

  _dom_manager__WEBPACK_IMPORTED_MODULE_3__["DomAppManager"].template = template;
  Object(_register_js__WEBPACK_IMPORTED_MODULE_2__["registerTypes"])([_dom_manager__WEBPACK_IMPORTED_MODULE_3__["DomAppManager"]].concat(types));
  var a = new _component_js__WEBPACK_IMPORTED_MODULE_0__["Component"](_dom_manager__WEBPACK_IMPORTED_MODULE_3__["DomAppManager"], {
    props: props
  });

  var fn = function fn() {
    Object(_render__WEBPACK_IMPORTED_MODULE_1__["render"])(a);
    a.init();
  };
...
var REGISTRY = new Map(_fragment_js__WEBPACK_IMPORTED_MODULE_2__["allFragments"]);
